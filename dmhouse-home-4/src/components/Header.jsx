...
export default function Header() {
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            tl.to('.scroll-indicator', { autoAlpha: 1, y: 0, duration: 0.8, ease: "power2.out" }, "-=0.6");
    ...
    return (
        <div ref={headerRef}>
            ...
            <header className={`site-header ${showBottomBar ? 'is-hidden' : ''} ${isLoaded ? 'is-loaded' : ''} page-container`}>
