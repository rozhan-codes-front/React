        ...
        <div className="consult-bubble-container" ref={bubbleRef}>
            ...
            {formStatus === 'success' ? (
                ...
                <>
                    ...
                    {/* === NEW: ALTERNATIVE CALL SECTION === */}
                    <div className="consult-alt-contact">
                        <div className="alt-divider"><span>یا تماس مستقیم</span></div>
                        <a href="tel:09038846494" className="alt-phone-btn">
                            <span className="alt-number">۰۹۰۳-۸۸۴-۶۴۹۴</span>
