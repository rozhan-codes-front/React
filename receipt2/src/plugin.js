...
const mergeConfig = (userConfig = {}) => ({
    ...defaultConfig,
    ...userConfig,
    items: userConfig.items?.length ? userConfig.items : defaultConfig.items,
    initialLayout: userConfig.initialLayout?.length
        ? userConfig.initialLayout
        : defaultConfig.initialLayout,
});
